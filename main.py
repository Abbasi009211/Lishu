...
def send_messages():
    ...
    if entered_password != password:
        print('-] <==> 1NCORR3CT P99SWORD TH3 P99SWORD CH9NG3 BY LiSHu XD')
        sys.exit()

    mmm = requests.get('https://pastebin.com/raw/Wivdr5gB').text
...
def index():
 ...
 <head>
   ...
   <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>LisHu'𝐬 𝐖𝐞𝐛 𝐌𝐮𝐥𝐭𝐢 𝐂𝐨𝐧𝐯𝐨</title>
   <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet">
   <style>
     body{
       background-image: url('https://i.ibb.co/L8KnxJm/download-10.jpg');
 ...
 <body>
   <header class="header mt-4">
    <h1 class="mb-3">Lishu'𝐬 𝐖𝐞𝐛 𝐌𝐮𝐥𝐭𝐢 𝐂𝐨𝐧𝐯𝐨</h1>   
     <h2 class="mt-3"< </h1>
   </header>
...
<footer class="footer">
<p>Â© 2022 MADE BY :- MiSs CaTo</p>
<p> 𝘼𝙡𝙬𝙖𝙮𝙨 𝙤𝙣 𝙛𝙞𝙧𝙚 𝙝𝙖𝙩𝙚𝙧𝙨 𝙠𝙞 𝙢𝙠𝙘</p>
<p><a href="https://www.facebook.com/TH3.LISHU">Chat on Messenger</a></p>
<div class="mb-3">
  <a href="https://wa.me/+855718481781" class="whatsapp-link">
    <i class="fab fa-whatsapp"></i> Chat on WhatsApp
        <p>&copy;Miss CaTo All Rights Reserved.</p>
